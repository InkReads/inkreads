...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="max-w-5xl flex justify-evenly items-center gap-48">
        <HeroIntro />
        <Image src={HeroImage} alt="hero-image" height={750} className="rounded-xl object-cover hidden lg:inline-block"/>
      </div>
    </section>
  );
}
